        ...
        switch (holder.getItemViewType()) {
            case 1: {
                ...
                holder1.popbut.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        holder1.pop(post_Id,userBlogList,position);
                    }
                });
                break;
            }
            case 2: {
                ...
                final DocumentReference userDocRef = firestore.collection("Users").document(CurrentUser);
                userDocRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
...
*/
                ...
                holder2.popbut.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        holder2.pop(post_Id,userBlogList, position);
                    }
                });
