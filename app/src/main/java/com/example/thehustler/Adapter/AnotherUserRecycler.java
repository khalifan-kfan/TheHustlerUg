...
public class AnotherUserRecycler extends RecyclerView.Adapter<AnotherUserRecycler.ViewHolder>  {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        userDocRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            holder.popbut.setEnabled(false);
            holder.popbut.setVisibility(View.INVISIBLE);
