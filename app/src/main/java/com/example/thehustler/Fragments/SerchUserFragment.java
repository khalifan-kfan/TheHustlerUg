...
public class SerchUserFragment extends Fragment implements Update {
    ...
    public SerchUserFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static SerchUserFragment newInstance() {
        SerchUserFragment fragment = new SerchUserFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =inflater.inflate(R.layout.fragment_serch_user, container, false);

        // Inflate the layout for this fragment
        views = v.findViewById(R.id.Recyclersuser);
        prog = v.findViewById(R.id.prog_SeachU);
...
class userAdapter  extends RecyclerView.Adapter<userAdapter.ViewHolder> {
    ...
    public userAdapter( List<Users> users_lists) {
